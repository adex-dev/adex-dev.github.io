  ...
  <div className="about-grid">
    ...
    <div className="about-content">
      ...
      <div className="about-facts">
        <div className="about-fact"><span className="about-fact-icon">▸</span> Based in Indonesia</div>
        <div className="about-fact"><span className="about-fact-icon">▸</span> Available for remote freelance</div>
        <div className="about-fact"><span className="about-fact-icon">▸</span> Speaks Indonesian & English</div>
        <div className="about-fact"><span className="about-fact-icon">▸</span> Currently learning Rust/Axum</div>
        <div className="about-fact"><span className="about-fact-icon">▸</span> ERP: Oracle NetSuite, Odoo</div>
        <div className="about-fact"><span className="about-fact-icon">▸</span> 50% DP to start projects</div>
      </div>
    </div>
  </div>
</section>
