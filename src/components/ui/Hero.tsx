...
const Hero: React.FC = () => {
  ...
  return (
    <section className={`hero ${config.hero.box}`}>
      ...
      <div className={`hero-right ${config.hero.right} ${config.hiddens}`}>
      ...
      <div className={`stack-bar ${config.hiddens} ${config.hero.stackBar}`}>
        ...
        >
          <svg className={`stack-icon ${config.hero.stackIcon}`} viewBox='0 0 52 52' fill='none'>
            ...
            />
            <path
              d='M13 18 L13 34 C13 37 19 40 26 40 C33 40 39 37 39 34 L39 18'
              stroke='#336791'
              strokeWidth='2'
              fill='none'
            />
        ...
        >
          <svg className={`stack-icon ${config.hero.stackIcon}`} viewBox='0 0 52 52' fill='none'>
            ...
            />
            <path
              d='M32 42 C36 42 38 39 38 36 L38 30 L26 30 L26 28 L42 28 C42 28 46 27 46 20 C46 13 42 12 38 12 L34 12 L34 18 C34 21 32 24 26 24 L16 24 C12 24 10 27 10 30 L10 36 C10 39 12 42 16 42 Z'
              fill='#FFD43B'
              fillOpacity='0.7'
            />
