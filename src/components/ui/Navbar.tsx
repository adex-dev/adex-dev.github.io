...
const Navbar: React.FC = () => {
  ...
  const [hashPoint, setHash] = useState(window.location.hash);
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <>
        ...
        <div className="navbar">
          <div ref={navRef} className={`${config.navbar.displayText}`}>
            <div
              ...
              {["About", "Services", "Projects", "Game", "Contact"].map(
                (item) =>
              ...
              <div className="menu-inner">
                ...
                <div className="menu-bottom">
                  ...
                  <div className="menu-social">
                    <a href="https://www.linkedin.com/in/akmadnudin">
                      LinkedIn
                    </a>
      ...
      <div className={`bottom-nav ${config.navbar.displayText==='hidden' ? '' : 'hidden'}`}>
        <div className="mobileNav">
          <Link
            to="/"
            onClick={() => setHash('')}
            className={`mobileNav-item ${hashPoint === "" ? "activeMobile" : ""}`}>
            <svg
              viewBox="0 0 24 24"
              stroke="currentColor"
              fill="none"
          ...
          <Link
            ...
            className={`mobileNav-item ${hashPoint === "#projects" ? "activeMobile" : ""}`}>
            <svg
              viewBox="0 0 24 24"
              stroke="currentColor"
              fill="none"
          ...
          <Link
            ...
            className={`mobileNav-item ${hashPoint === "#services" ? "activeMobile" : ""}`}>
            <svg
              viewBox="0 0 24 24"
              stroke="currentColor"
              fill="none"
          ...
          <Link
            ...
            className={`mobileNav-item ${hashPoint === "#contact" ? "activeMobile" : ""}`}>
            <svg
              viewBox="0 0 24 24"
              stroke="currentColor"
              fill="none"
