  ...
  return (
    <section id="projects">
      ...
      <div className="projects-grid">
        <div className="project-card featured rust-project" onClick={()=>handlerclick('rust-axum')}>
          <div>
            <div className="project-num">
              <span className="project-num-dot personal"></span>
              Personal Project · 2024
            </div>
            <div className="project-name">REST API Backend — Rust & Axum</div>
        ...
        {[...projectMaps].reverse().map((project, index) => (
          <div onClick={()=>handlerclick(project.id)} key={index} className="project-card beam">
