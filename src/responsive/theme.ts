...
export const theme = {
  ...
  "desktop-1280": {
    hero: {
      ...
      eyebrow:
        "gap-4 text-[clamp(0.75rem,calc(-9.038rem+12.235vmin),2.7rem)] mb-[clamp(0.5rem,calc(-4.52rem+6.275vmin),1.5rem)] tracking-[0.18em]",
      ...
      scrollHint:
        "bottom-[clamp(4rem,calc(12.784rem+-10.98vmin),2.25rem)] left-16 ",
    },
    about: {
